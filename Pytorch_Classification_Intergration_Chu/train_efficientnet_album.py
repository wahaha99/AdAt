...
import time
import argparse
from albumentations.augmentations.transforms import GaussianBlur, MedianBlur, MotionBlur, RandomBrightness, RandomContrast,  VerticalFlip
import cv2
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', type=str, default='/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/train_set', help='train_dir')  # train csv
    ...
    parser.add_argument('--root', type=str, default="/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/")
    parser.add_argument('--save_path', type=str, default='/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/checkpoints/b0300')
    ...
    albumentations_train = album.Compose([
        ...
        album.Normalize(mean=[0.7823419,  0.59793377, 0.7674322], std=[0.1811313,  0.2713135,  0.15672927]),
        ToTensorV2(),
    ])
    ...
    train_dataset = DatasetFromCSV("/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/my_data/Master project data/data_org_image/", "/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/my_data/Master project data/data_labels_train.csv", transforms=albumentations_train)
    valid_dataset = DatasetFromCSV("/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/my_data/Master project data/data_org_image/", "/content/gdrive/MyDrive/EQ2445/Pytorch_Classification_Intergration/my_data/Master project data/data_labels_validation.csv", transforms=albumentations_train)
    ...
    for epoch in range(epochs):
        ...
        optimizer_step.step()  # updata learning rate
